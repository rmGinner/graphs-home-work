...
public class DigraphGenerator {
    ...
    /**
     * Sets the random number generator seed, in order to get the same sequence of data
     * @param seed the seed
     */
   ...
   /**
    ...
    public static void main(String[] args) {
        int V = 30; //Integer.parseInt(args[0]);
        int E = 30; //Integer.parseInt(args[1]);
        
        setRandomSeed(10);
        
        StdOut.println("complete graph");
        StdOut.println(complete(V).toDot());
        StdOut.println();

        StdOut.println("simple");
        StdOut.println(simple(V, E).toDot());
        StdOut.println();

        StdOut.println("path");
        StdOut.println(path(V).toDot());
        StdOut.println();

        StdOut.println("cycle");
        StdOut.println(cycle(V).toDot());
        StdOut.println();

        StdOut.println("Eulierian path");
        StdOut.println(eulerianPath(V, E).toDot());
        StdOut.println();

        StdOut.println("Eulierian cycle");
        StdOut.println(eulerianCycle(V, E).toDot());
        StdOut.println();

        StdOut.println("binary tree");
        StdOut.println(binaryTree(V).toDot());
        StdOut.println();

        StdOut.println("tournament");
        StdOut.println(tournament(V).toDot());
        StdOut.println();

        StdOut.println("DAG");
        StdOut.println(dag(V, E).toDot());
        StdOut.println();

        StdOut.println("rooted-in DAG");
        StdOut.println(rootedInDAG(V, E).toDot());
        StdOut.println();

        StdOut.println("rooted-out DAG");
        StdOut.println(rootedOutDAG(V, E).toDot());
        StdOut.println();

        StdOut.println("rooted-in tree");
        StdOut.println(rootedInTree(V).toDot());
        StdOut.println();

        StdOut.println("rooted-out DAG");
        StdOut.println(rootedOutTree(V).toDot());
        StdOut.println();
    }
