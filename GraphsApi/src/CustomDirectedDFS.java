 ...
 *  @author Kevin Wayne
 */
public class CustomDirectedDFS {
    private boolean[] marked;  // marked[v] = true if v is reachable
                               // from source (or sources)
    private int count;         // number of vertices reachable from s

    private SymbolCustomDigraph symbolCustomDigraph;
     ...
     */
    public CustomDirectedDFS(SymbolCustomDigraph symbolCustomDigraph, int s) {
        this.symbolCustomDigraph = symbolCustomDigraph;
        Digraph digraph = symbolCustomDigraph.digraph();
     ...
     */
    public CustomDirectedDFS(Digraph G, Iterable<Integer> sources) {
